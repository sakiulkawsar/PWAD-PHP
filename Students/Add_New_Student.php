          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              if (isset($_POST['submit'])) {
                ...
                $sql = "INSERT INTO students(first_name, last_name, birthdate, notes) 
                    VALUES('$first_name', '$last_name', '$birth_date', '$note')";
                $db->query($sql);
              ...
              <div class="card card-primary">
                ...
                <!-- form start -->
                <form id="quickForm" action="Add_New_Student.php" method="POST">
                  <div class="card-body">
